...
Revision ID: ad13f3f831be
Revises: 
Create Date: 2022-06-14 01:35:05.234513
...
def upgrade():
    ...
    op.create_foreign_key(
        "fk_password_reset_links_session_uuid",
        "password_reset_links",
        "sessions",
        ["session_uuid"],
        ["session_uuid"],
    ...
    op.create_foreign_key(
        "fk_password_reset_links_user_uuid",
        "password_reset_links",
        "users",
        ["user_uuid"],
        ["user_uuid"],
