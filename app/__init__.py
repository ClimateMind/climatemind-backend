...
def create_app(config_class=DevelopmentConfig):
    ...
    origins = {
        "origins": [
            ...
            "http://localhost:3000",
            "http://0.0.0.0:3000",
            "http://app-frontend-test-001.azurewebsites.net:80",
            "https://app-frontend-test-001.azurewebsites.net:80",
            "http://app-frontend-prod-001.azurewebsites.net:80",
            "https://app-frontend-prod-001.azurewebsites.net:80",
            "http://app.climatemind.org:80",
            "https://app.climatemind.org:80",
            "http://app-frontend-test-001.azurewebsites.net",
            "https://app-frontend-test-001.azurewebsites.net",
            "http://app-frontend-prod-001.azurewebsites.net",
