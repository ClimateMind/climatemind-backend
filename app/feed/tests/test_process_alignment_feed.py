...
def test_find_alignment_solution_iris():
    ...
    solution_iris = find_alignment_solution_iris(CONVERSATION_SOLUTION_NAME, POPULAR_SOLUTION_NAMES, POPULAR_SOLUTION_COUNT, UNPOPULAR_SOLUTION_COUNT)
    expected_conversation_iri = solution_iris[0]
    popular_iris = [iri for iri in solution_iris[1:] if iri_label_map[iri] in POPULAR_SOLUTION_NAMES]
    unpopular_iris = [iri for iri in solution_iris[1:] if iri_label_map[iri] not in POPULAR_SOLUTION_NAMES]
