...
def search_node(ontology, start_point):
    ont_start_point = ontology.search_one(label=start_point)
    node_network = Network(ontology, "causes_or_promotes", ont_start_point)
...
def main(args):
    ...
    edges = search_node(onto, target_node_label)
