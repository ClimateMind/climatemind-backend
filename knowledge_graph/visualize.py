...
def get_figure(
    N_node_details, N_edge_details, N, G, edge_type=None, node_class=None, node_property=None, extra_edge_type=None):
    the_nodes_to_display, the_edges_to_display = get_filtered_data(N_node_details, N_edge_details, N, G, edge_type)
    # blank figure object
    fig = go.Figure()
    ...
    fig.update_layout(showlegend=False, plot_bgcolor="rgba(0,0,0,0)", height = 700,
                                xaxis =  {                                     
                                    'showgrid': False
                                         },
                                yaxis = {                              
...
if __name__ == '__main__':
    ...
    parser.add_argument("gpickle_file_path", type=str, help='path to reference networkx gpickle object')
