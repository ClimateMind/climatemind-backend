...
def upgrade():
    ...
    op.drop_constraint(
        "FK__climate_f__sessi__00200768", "climate_feed", type_="foreignkey"
    )
    ...
    op.drop_constraint("FK__scores__user_id__619B8048", "scores", type_="foreignkey")
    op.drop_constraint("FK__scores__session___60A75C0F", "scores", type_="foreignkey")
    op.add_column(
...
def downgrade():
    ...
    op.create_foreign_key(
        "FK__signup__session___01142BA1",
        "signup",
        "sessions",
        ["session_id"],
        ["session_id"],
    ...
    op.create_foreign_key(
        "FK__scores__session___60A75C0F",
        "scores",
        "sessions",
        ["session_id"],
        ["session_id"],
    ...
    op.create_foreign_key(
        "FK__scores__user_id__619B8048", "scores", "users", ["user_id"], ["user_id"]
    )
    ...
    op.create_foreign_key(
        "FK__climate_f__sessi__00200768",
        "climate_feed",
        "sessions",
        ["session_id"],
        ["session_id"],
