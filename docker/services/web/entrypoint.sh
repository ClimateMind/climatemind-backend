...
# flask db migrate -m "CM-566 Password reset link table" -d $BASEDIR/migrations_azure
# flask db migrate -m "CM-566 Password reset link table" -d $BASEDIR/migrations_test_db
