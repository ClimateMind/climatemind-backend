...
# flask db migrate -m "CM-1045 V2 convo state and user a rating" -d $BASEDIR/migrations_azure
# flask db migrate -m "CM-1045 V2 convo state and user a rating" -d $BASEDIR/migrations_test_db
